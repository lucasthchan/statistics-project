...
\- Comparing median ages between two time could highlight whether the Wellspring’s current system are effectively impacting the engagement of members across different backgrounds, informing decisions about whether they need to change the registration system
...
In our visualization, median of the age between two groups are very similar, around 60 years old. Spread of the age between two groups are also very similar based on IQR is around 50 to 70 years old. Thus, the overall age distribution of the members did not significantly change showing that there is less influence of ages after the system update.

Outliers of younger ages appear less frequently after March 4^th^, 2024, showing that decreasing engagement from younger members.

P-value is 0.9346 by using bootstrap, which is larger than 0.05. So it fails to reject the null hypothesis showing that the median age difference is not significant.

# Conclusion

The majority of members who attend the services are around 60 years old, with younger age groups generally being less involved. After the system change, the number of young members increased with a small proportion, but the overall impact of age on engagement in Wellspring remained minimal. Additionally, there was no significant association between age and the number of services attended.
...
So we can attract more younger members to engage the Wellspring and continue to provide suitable programs for old members to make sure they attend programs frequntly, and pay attention to the event formats by offering more in-person programs.
